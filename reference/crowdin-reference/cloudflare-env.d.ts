/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 03b2f719ef810b25bce9caa860ae48c2)
// Runtime types generated with workerd@1.20251004.0 2025-07-30 enable_nodejs_http_modules,enable_nodejs_http_server_modules,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		URL: string;
		CROWDIN_CLIENT_ID: string;
		CROWDIN_CLIENT_SECRET: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "URL" | "CROWDIN_CLIENT_ID" | "CROWDIN_CLIENT_SECRET">> {}
}
