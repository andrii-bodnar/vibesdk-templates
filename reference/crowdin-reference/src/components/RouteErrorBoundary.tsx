...
export function RouteErrorBoundary() {
  ...
  const message = !inRouter
    ...
    : 'This router does not support route errors. Use createHashRouter + RouterProvider.'
  ...
  // Guard: If this component is rendered outside of a data router (e.g. HashRouter)
